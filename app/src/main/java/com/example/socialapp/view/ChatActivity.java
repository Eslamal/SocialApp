...
import com.example.socialapp.adapter.MessagesAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReceiversUID = String.valueOf(getIntent().getIntExtra("uid",0));
        ...
        chatReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.messageAdapter.scrollToPosition(messagesArrayList.size() - 1); // Scroll to the last message
            }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                sImage = snapshot.child("imageUri").getValue(String.class);
